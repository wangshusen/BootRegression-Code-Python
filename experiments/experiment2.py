...
def experiment(a, b, tList, sketch, numRepeat, numBoot):
    ...
    for r in range(numRepeat):
        ...
        for i in range(tLen):
            ...
            wT = numpy.linalg.lstsq(aSketchT, bSketchT)[0]
            ...
            numIterEmpirical[r, i] = 0 #results[2]
            ...
            for boot in range(numBoot):
                ...
                aTilde = aSketchT[idx, :]
                bTilde = bSketchT[idx, :]
                wTilde = numpy.linalg.lstsq(aTilde, bTilde)[0]
                ...
                numIterBoot[r, i, boot] = 0 #results[2]
